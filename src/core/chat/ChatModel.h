...
public:
    ...
    Q_INVOKABLE bool ingestRemoteMessage(const QString &remoteId, const QString &text, const QString &sender, bool isOwn, double ts, bool isSystem = false);
    ...
    Q_INVOKABLE bool ingestRemoteAttachment(const QString &remoteId, const QVariantMap &media, const QString &sender, bool isOwn, double ts);
